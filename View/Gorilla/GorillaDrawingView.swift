...
struct GorillaDrawingView: View {
                ...
                VStack {
                    HStack(spacing: 10) {
                        ...
                        HStack(spacing: 20){
                            ...
                            Button(action: {
                                selectedColor = Color("GodongColor")
                                gray = true
                                black = false
                                green = false
                            }, label: {
                                gray
                                ? Image("SelectedGodong")
                                    .resizable()
                                    .scaledToFit()
                                    .frame(width: geometry.size.width/30,height: geometry.size.height/20)
                                : Image("Godong")
                        ...
                        NavigationLink(destination: GorillaCompareView( simili: $simili, captureImage: $captureImage, isPresented: $isPresented), isActive: $isPresented) {
                            Button(action: {
                                captureScreen()
                                isPresented = true
...
struct GorillaDrawingView_Previews: PreviewProvider {
