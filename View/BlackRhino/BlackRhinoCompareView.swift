...
//struct BlackRhinoCompareView: View {
//
...
//                //                GeometryReader {  geometry in
//                ZStack{
//                    NavigationLink(destination: BlackRhinoDetailView(), isActive: $isElephantDetailActive){
//                        Button(action: {
...
//                                guard let img2 = UIImage(named: "img_blackRhino") else { return }
...
//                        }.opacity(simility ? 0 : 1)
                        ...
                        if simili >=  50.55 {
                            NavigationLink(destination: BlackRhinoDetailView(), isActive: $isGorillaActive){
                                Button(action: {
...
struct BalckRhinoCompareView_Previews: PreviewProvider {
